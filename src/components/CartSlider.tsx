...
export default function CartSlider() {
	...
	return (
		<Sheet>
			...
			<SheetContent
				side="right"
				className="w-full min-w-sm md:min-w-lg bg-white overflow-y-auto p-6 flex flex-col"
			>
							...
							>
								...
								<div className="flex-1">
									...
									<div className="flex items-center mt-2">
										<div className="flex items-center border border-gray-300">
											...
											<div className="px-3 min-w-12 text-center">
												{item.quantity}
											</div>
								...
								<div>
									<p className="text-lg text-right">
										{siteConfig.currency}
										<br /> {Math.floor(+item.price * +item.quantity).toFixed(2)}
									</p>
								</div>
							</div>
						))
